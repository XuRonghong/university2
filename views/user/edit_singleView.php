...
<div id="wrapper">
	...
	<div id="contain">
	<div id="_top"><strong>‧ </strong><a href="index.php">首頁</a> &gt; 台灣全國大專院校 &gt;     <?php
	...
	<div id="main"> 
	<form id="editform" action="<?php echo $_SERVER['PHP_SELF'].'?c=user&a=edit&p='.$row_uni_sing['uId'];?>" method="POST">
		<ul id='ul_single'>
			<li><h5>學校名稱：</h5><input class="tex" name="uName" type="text" placeholder="國立臺灣大學" value="<?php echo $row_uni_sing['uName']; ?>"></li>
			<li><h5>學校代碼：</h5><input class="tex" name="uNumber" type="text" value="<?php echo $row_uni_sing['uNumber']; ?>"></li>
			<li><h5>學校網址：</h5><input class="tex" name="uWeb" type="text" value="<?php echo $row_uni_sing['uWeb']; ?>"><font size='small' color='red'> 開頭加http://</font></li>
			<li><h5>學校地址：</h5><input class="tex" name="uLocation" type="text" id="source" onblur="trans();" value="<?php echo $row_uni_sing['uLocation']; ?>">
			...
			<li><h5>學校電話：</h5><input class="tex" name="uPhone" type="text" value="<?php echo $row_uni_sing['uPhone']; ?>"></li>
			
			<li><h5>台灣縣市：</h5>
				<select name="uCounties"  class="tex">				
				...
				</select><font size='small' color='red'>此選項要重新選擇</font>
			</li>
			<li><h5>學校類型：</h5>
				<input type="radio" name="uType" value="[1]一般" <?php if($row_uni_sing['uType']==="[1]一般")echo "checked";?> >一般
				<input type="radio" name="uType" value="[2]技職" <?php if($row_uni_sing['uType']==="[2]技職")echo "checked";?> >技職
				<input type="radio" name="uType" value="[3]師範" <?php if($row_uni_sing['uType']==="[3]師範")echo "checked";?> >師範
				<input type="radio" name="uType" value="[4]其他" <?php if($row_uni_sing['uType']==="[4]其他")echo "checked";?> >其他
			</li>
		</ul>
		...
		<textarea name="aContent" rows='30' cols='90'>
			<?php echo ($row_uni_sing['aContent']); ?>
		</textarea>
