...
$query_uni_national = "SELECT * FROM `university` WHERE university.uName LIKE '%國立%' AND university.uType NOT LIKE '%技職%'";
$uni_national = mysql_query($query_uni_national, $conn_university_list) or die(mysql_error());
$row_uni_national = mysql_fetch_assoc($uni_national);
$totalRows_uni_national = mysql_num_rows($uni_national);
...
<div id="contain">
<div id="_top"><strong>‧ </strong><a href="index.php">首頁</a> &gt; <a href="classfly.php">分類找尋</a>  &gt; 公立大學</div>
