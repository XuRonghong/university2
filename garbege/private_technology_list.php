...
$query_uni_national = "SELECT * FROM university WHERE university.uName NOT LIKE '%國立%' AND university.uType  LIKE '%技職%'";
...
<div id="contain">
<div id="_top"><strong>‧ </strong><a href="index.php">首頁</a> &gt; <a href="classfly.php">分類找尋</a>  &gt; 私立技職大學</div>
